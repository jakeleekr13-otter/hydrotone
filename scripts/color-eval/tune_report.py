...
table("MARKET target pairs (ref = market 'after'; m3 is a creative mood grade)", m, ["m1.png", "m2.png", "m3.png", "m4.png"])
...
sheet(f"{O}/market", ["m1.png", "m2.png", "m3.png", "m4.png", "n_grey.png"], cols, f"{O}/market_sheet.jpg")
